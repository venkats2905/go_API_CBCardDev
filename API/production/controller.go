...
func getProductionByID(c *gin.Context) {
	...
	// If no matching Production schedule was found
...
func addProduction(c *gin.Context) {
	...
	//db := dataservice.ConnectToDb()
	Productionschedules = dataservice.GetProductionScheduleFromDb(Productionschedules)
	dataservice.PostAddProductionToDb(newproductionschedules)
...
func deleteProductionByID(c *gin.Context) {
	...
	for index, a := range Productionschedules {
		...
		if a.Jobname == jobname {
			//db := dataservice.ConnectToDb()
			dataservice.DeleteAlbumFromDb(a.Jobname)
...
func updateProductionByID(c *gin.Context) {
	...
	for index, a := range Productionschedules {
		if a.Jobname == jobname {
			...
			//db := dataservice.ConnectToDb()
			dataservice.UpdateProductionInDb(updatedProductionschedule)
