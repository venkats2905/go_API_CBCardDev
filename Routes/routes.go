...
func Routes() {
	...
	router.GET("/tracking", cr.Gettrackler)
	router.GET("/tracking/:SID", cr.GetBySID)
	router.POST("/tracking", cr.Adddata)
	router.PUT("/tracking/:SID", cr.UpdatetracklerbyID)
	router.DELETE("/tracking/:SID", cr.DeletetracklerByID)
